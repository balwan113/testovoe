...
func (m *MockUserRepository) UpdateUser(ctx context.Context, id int64, user *domain.User) error {
...
func TestGetUserByID_NotFound(t *testing.T) {
	...
	mockRepo.On("GetUserByID", mock.Anything, int64(1)).Return((*domain.User)(nil), errors.New("пользователь не найден"))
